    ...
    render() {
        return (
            <Switch>
                ...
                <Route exact path={`${this.urlPrefix}/apartment/list/:filterUrlFragment?`} component={ApartmentList} />
                <Route exact path={`${this.urlPrefix}/apartment/:filterUrlFragment?`} component={ApartmentList} />
